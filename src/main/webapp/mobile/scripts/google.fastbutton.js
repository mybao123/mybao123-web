(function() {
	/**
	 * From: http://code.this.com/mobile/articles/fast_buttons.html Also see:
	...
	this.FastButton = function(element, handler, useCapture) {
		...
		if (isTouch)
			this.events.push(addListener(element, 'touchstart', this,
					this.useCapture));
	 ...
	 * other behaviors don’t get a chance to handle the same click event. This
	 * is executed at the beginning of touch.
	 */
	this.FastButton.prototype.onTouchStart = function(event) {
		event.stopPropagation ? event.stopPropagation()
				: (event.cancelBubble = true);
		this.touchEvents.push(addListener(this.element, 'touchend', this,
				this.useCapture));
		this.touchEvents.push(addListener(document.body, 'touchmove', this,
				this.useCapture));
	...
	if (isTouch) {
		// Don't need to use our custom addListener function since we only bust
		// clicks on touch devices
